...
public class PKCS7 {
     ...
     * @param external whether the content should be excluded from output
     * @param direct if the content is signed directly or thru authattrs
    ...
    public static byte[] generateNewSignedData(
            ...
            byte[] content, boolean external, boolean direct,
        ...
        return constructToken(signature, signerChain, external ? null : content,
                authAttrs,
     ...
     * @param unauthAttrs (optional) unauthorised attributes
